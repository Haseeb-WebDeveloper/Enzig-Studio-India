                    ...
                    >
                        <div className="flex gap-12 md:gap-20 flex-col">
                            ...
                            <div className="w-full flex flex-row overflow-x-auto md:overflow-x-visible pt-8 px-8 md:pt-0 md:px-0 gap-12 items-center justify-between">
                                ...
                                >
                                    <Image src="/creativity-content/branding-logo.svg" alt="Strategies Logo" width={100} height={100} className="w-[22px] h-[22px] hidden md:block" />
                                ...
                                >
                                    <Image src="/creativity-content/content-creation-logo.svg" alt="Content Creation Logo" width={100} height={100} className="w-[22px] h-[22px] hidden md:block" />
                                ...
                                >
                                    <Image src="/creativity-content/smm-logo.svg" alt="SMM Logo" width={100} height={100} className="w-[22px] h-[22px] hidden md:block" />
                                ...
                                >
                                    <Image src="/creativity-content/packaging-print-logo.svg" alt="Packaging & Print Logo" width={100} height={100} className="w-[22px] h-[22px] hidden md:block" />
