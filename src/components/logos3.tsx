    ...
    <section className="">
      ...
      <div className={`${absolute ? "absolute bottom-16 left-0 w-full h-full" : ""}`}>
        <div className="relative mx-auto flex items-center justify-center lg:max-w-5xl">
          ...
          <div className="absolute inset-y-0 left-0 w-12 bg-gradient-to-r from-foreground to-transparent"></div>
          <div className="absolute inset-y-0 right-0 w-12 bg-gradient-to-l from-foreground to-transparent"></div>
        </div>
      </div>
    </section>
  );
